...
import 'package:expences_tracker/widgets/chart/chart_bar.dart';
...
class Chart extends StatelessWidget {
  ...
  double get maxTotalExpense {
    ...
    for (final bucket in buckets) {
      if (bucket.totalExpence > maxTotalExpense) {
        maxTotalExpense = bucket.totalExpence;
      }
    }
                ...
                for (final bucket in buckets) // alternative to map()
                  ChartBar(
                    fill: bucket.totalExpence == 0
                        ? 0
                        : bucket.totalExpence / maxTotalExpense,
                  )
              ],
            ),
          ),
